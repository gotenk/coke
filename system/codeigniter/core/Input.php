...
class CI_Input {
	...
	public function __construct()
	{
		...
		//selen
		$this->_enable_csrf_multi_form = (config_item('csrf_multi_form') === TRUE);
	...
	protected function _sanitize_globals()
	{
		...
		if($this->_enable_csrf_multi_form === TRUE)
		{
			$this->security->verify_multiple_csrf_token();
		}
		else if ($this->_enable_csrf === TRUE)
		{
