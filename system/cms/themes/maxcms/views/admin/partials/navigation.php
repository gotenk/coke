	...
	<li id="dashboard-link"><?php echo anchor(ADMIN_URL, lang('global:dashboard'), 'class="top-link '.( ! $this->module ? 'current ' : '').'"') ?></li>
		...
		foreach ($menu_items as $key => $menu_item)
		{
			if (is_array($menu_item))
			{
				...
				{
					//if (site_url($uri)!= "https://testramadan.coca-cola.co.id/p4n3lb04rd/maintenance" && site_url($uri)!= "https://testramadan.coca-cola.co.id/p4n3lb04rd/groups" && site_url($uri)!= "https://testramadan.coca-cola.co.id/p4n3lb04rd/addons/plugins")
