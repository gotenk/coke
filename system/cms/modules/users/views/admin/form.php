<section class="title">
	<?php if ($this->method === 'create'): ?>
		...
		<?php echo cmc_form_open_multipart('frm_users_edit',uri_string(), 'class="crud" autocomplete="off"') ?>
	
	<?php else: ?>
		<h4><?php echo sprintf(lang('user:edit_title'), $member->username) ?></h4>
		<?php echo cmc_form_open_multipart('frm_users_edit',uri_string(), 'class="crud"') ?>
