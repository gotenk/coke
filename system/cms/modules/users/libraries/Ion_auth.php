...
class Ion_auth
{
	 ...
	 * @author Mathew
	 **/
	public function register($username, $password, $email,$parent_email, $group_id = null, $additional_data = array(), $group_name = false,$my_extra=array())
	{
		
		$id = $this->ci->ion_auth_model->register($username, $password, $email,$parent_email, $group_id, $additional_data, $group_name,$my_extra);
